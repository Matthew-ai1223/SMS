...
<body>
    <div class="admin-container">
        <div class="admin-header">
            ...
            <p>Manage school registrations and system overview</p>
        </div>
    ...
    <script>
                        ...
                        ${schools.map(school => `
                            <tr>
                                ...
                                <td class="action-buttons">
                                    <button class="btn btn-view" onclick="viewSchool(${school.id})">
                                        <i class="fas fa-eye"></i> View
                                    </button>
                                    ${school.status === 'pending' ? `
                                        <button class="btn btn-approve" onclick="approveSchool(${school.id})">
                                            <i class="fas fa-check"></i> Approve
                                        </button>
                                        <button class="btn btn-reject" onclick="rejectSchool(${school.id})">
        ...
        function updateSchoolStatus(schoolId, status) {
            fetch('../api/admin/update-status.php', {
                method: 'POST',
                headers: {
